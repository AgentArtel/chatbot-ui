...
AS $$
DECLARE
  project_url TEXT := 'https://vgoqcxtvqenohalofilc.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZnb3FjeHR2cWVub2hhbG9maWxjIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcyNTQ5MTUxMiwiZXhwIjoyMDQxMDY3NTEyfQ.OSEtr9WYTe6wmCMJ0PRoYvjomrO9Y4iM68W5zE3AFG4'; -- full access needed for http request to storage
